        ...
        try {
            ...
            while (sc.hasNextLine()) {
                if(count==2){
                    ...
                    int client_index = (sensorID-1) % this.producersNum;
                    System.out.println(sensorID+ " --- "+client_index);
                    if(clients[client_index].createSocket())
                        clients[client_index].writeObject("CONTENT-ID:"+content[0]+" TEMP:"+content[1]+" TIME:"+content[2]);
                    count=0;
                }
                else{
